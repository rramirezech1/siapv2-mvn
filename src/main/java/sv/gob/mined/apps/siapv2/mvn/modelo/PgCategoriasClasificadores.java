 ...
 * @author Infosoft
 */
public class PgCategoriasClasificadores {
    ...
    public PgCategoriasClasificadores() {
    }

    public PgCategoriasClasificadores(Integer idCategoria) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PgCategoriasClasificadores)) {
            return false;
        }
        PgCategoriasClasificadores other = (PgCategoriasClasificadores) object;
    ...
    public String toString() {
        return "sv.gob.mined.apps.bnprove.mvn.modelo.PgCategoriasClasificadores[ idCategoria=" + idCategoria + " ]";
    }
}
