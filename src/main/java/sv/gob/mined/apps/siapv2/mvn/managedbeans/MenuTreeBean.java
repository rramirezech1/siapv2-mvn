...
public class MenuTreeBean implements Serializable {
    ...
    public void init() {
        ...
        TreeNode node6 = new DefaultTreeNode(new OpcionMenu("1.6. Translado de Oferentes", "/app/control/oferentes/regTrasladoOferentes.jsf"), node0);
        TreeNode node7 = new DefaultTreeNode("2. Reportes Control Contratistas",root);
        TreeNode node8 = new DefaultTreeNode(new OpcionMenu("2.1. Control de Garantias", "#"), node7);
        TreeNode node9 = new DefaultTreeNode(new OpcionMenu("2.2. Reportes Adicionales", "#"), node7);   
        TreeNode node10 = new DefaultTreeNode("3. Consultas Control Oferentes", root);
        TreeNode node11 = new DefaultTreeNode(new OpcionMenu("3.1. Oferentes Registrados", "/app/consultas/oferentesRegistrados.jsf"), node10);
        TreeNode node12 = new DefaultTreeNode(new OpcionMenu("3.2. Oferentes Contratados", "/app/consultas/oferentesContratados.jsf"), node10);
        TreeNode node13 = new DefaultTreeNode(new OpcionMenu("3.3. Busqueda de Oferentes", "/app/consultas/busquedaOferentes.jsf"), node10);
        TreeNode node14 = new DefaultTreeNode("4. POA, Reprogramaciones", root);
        TreeNode node15 = new DefaultTreeNode(new OpcionMenu("4.1. Planes Globales", "/app/regPlanGlobal2.jsf"), node14);
        TreeNode node16 = new DefaultTreeNode(new OpcionMenu("4.2. Reprogramaciones POA", "/app/regReprogramacion.jsf"), node14);
        TreeNode node17 = new DefaultTreeNode("5. Seguridad", root);
        TreeNode node18 = new DefaultTreeNode(new OpcionMenu("5.1. Admin. de Grupos", "/app/seguridad/regGrupo.jsf"), node17);
        TreeNode node19 = new DefaultTreeNode(new OpcionMenu("5.2. Asignacion Usuario-Grupos", "/app/seguridad/regUsuarioGrupo.jsf"), node17);
        TreeNode node20 = new DefaultTreeNode(new OpcionMenu("5.3. Admin. de Autorizacion", "/app/seguridad/regRoles.jsf"), node17);
        TreeNode node21 = new DefaultTreeNode(new OpcionMenu("5.4. Admin. de Acceso a Datos", "/app/seguridad/regRolesAutorizacion.jsf"), node17);
        TreeNode node22 = new DefaultTreeNode(new OpcionMenu("5.5. Verificacion", "/app/verificacion.jsf"), node17);
