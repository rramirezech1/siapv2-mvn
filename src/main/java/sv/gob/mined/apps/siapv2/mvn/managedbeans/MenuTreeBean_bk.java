...
@Scope(value = "view")
public class MenuTreeBean_bk implements Serializable {

    private TreeNode root;
    private TreeNode rootBn;
    private TreeNode selected;

    public MenuTreeBean_bk() {
    }
    ...
    public void init() {
        ...
        TreeNode node4 = new DefaultTreeNode(new OpcionMenu1("1.4. Registro de Garantías", "/app/control/oferentes/regGarantias.jsf"), node0);
        ...
        TreeNode node13 = new DefaultTreeNode(new OpcionMenu1("3.3. Oferentes SIAP", "/app/consultas/oferentesSiap.jsf"), node10);
